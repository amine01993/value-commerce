...
export default function Banners() {
    ...
    const nextItem = useCallback((diff: number = 0) => {
        // console.log('nextItem', activeIndex, activeScrollIndex.current, diff)
    ...
    const previousItem = useCallback((diff: number = 0) => {
        // console.log('previousItem', activeIndex, activeScrollIndex.current, diff)
        const nextIndex = activeIndex - 1;
        setActiveIndex(nextIndex);
        activeScrollIndex.current = nextIndex;
    ...
    const handleScrollEnd = useCallback(() => {
        // console.log('handleScrollEnd', activeScrollIndex.current)
